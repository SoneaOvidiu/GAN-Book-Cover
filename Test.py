...
def load_real_samples():
    dataset = []
    for directory in os.listdir('D:\\1. University\\5. Fifth Semester\\Deep Learning & Computer Vision\\GANs\\book-covers'):
        for file in os.listdir('D:\\1. University\\5. Fifth Semester\\Deep Learning & Computer Vision\\GANs\\book-covers' + '/' + directory):
